...
#include "3rdParty/platform/win32/GLES2/gl2.h"
#elif defined(PLATFORM_IOS)
...
#elif defined(PLATFORM_NACL) || defined(PLATFORM_QNX)
#include <GLES2/gl2.h>
#include <GLES2/gl2ext.h>
#endif

// hacking non-existing stuffz
#define glDrawBuffers(a,b)  do{}while(0)
#define glPolygonMode(a, b) do{}while(0)
#define glReadBuffer(a) do{}while(0)
#define glDrawBuffer(a) do{}while(0)

#define GL_TEXTURE_3D                     0x806F //handle missing 3d textures at runtime
#define GL_DEPTH_COMPONENT24              0x81A6
//#define GL_BGRA                           0x80E1 //TODO: is this supported on all platform???
...
#define GL_CLAMP_TO_BORDER                0x812D	//not supported on es2

//for 3d textures only!
#define GL_TEXTURE_WRAP_R                 0x8072
#define GL_COMPARE_R_TO_TEXTURE           0x884E	//shadow map?
